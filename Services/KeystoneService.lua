...
addon.KeystoneService = addon.KeystoneService or {}
...
function addon.KeystoneService:findInBags()
    for bag = 0, 4 do
...
---@return string|nil
function addon.KeystoneService:getItemLink()
    local bag, slot = self:findInBags()
    if not bag then
        return nil
    end
...
function addon.KeystoneService:getOwned()
...
---@return string|nil
function addon.KeystoneService:formatOwned()
...
---keystone is owned.
function addon.KeystoneService:announceToGroup()
