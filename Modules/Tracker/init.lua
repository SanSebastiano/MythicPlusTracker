...
frame = addon.createDefaultFrame("Tracker Dashboard", 800, 600, true, false)
frame:Hide()
...
-- Dashboard als Teil des Addon-Objekts verfügbar machen
addon.trackerDashboard = {
    frame = frame,
    loadDungeonInfo = loadDungeonInfo
}

-- Dashboard Informationen laden wenn das Frame gezeigt wird
MPT_GreatVaultButton:load(frame)
