...
local locale = {
    ...
    ["KEYSTONES_GUILD_NEXT_UPDATE"] = "Próxima actualización al iniciar sesión, completar una mazmorra, intercambiar la llave, o recibir una difusión de la hermandad",
