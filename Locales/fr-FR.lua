...
local locale = {
    ...
    ["KEYSTONES_GUILD_NEXT_UPDATE"] = "Prochaine mise à jour lors de la connexion, de la fin d'un donjon, d'un échange de clé, ou d'une diffusion entrante de la guilde",
